  ...
  return (
    <div className="relative w-full">
      <div className="relative">
        ...
        <Input className="pl-10 pr-12" placeholder="책 제목, 저자, 학과 등으로 검색" type="search" />
          ...
          <SheetContent className="w-full sm:max-w-md">
            ...
            <div className="mt-6 space-y-6">
              ...
              <div className="space-y-2">
                <Label>판매자 평점</Label>
                <Select
                  value={filters.sellerRating.toString()}
                  onValueChange={(value) => setFilters((prev) => ({ ...prev, sellerRating: Number(value) }))}
                >
                  <SelectTrigger>
                    <SelectValue placeholder="최소 평점 선택" />
                  </SelectTrigger>
                  <SelectContent>
